		...
		<div class="p_inner2 p_flex p_jc_between">
			...
			<div class="l_content">
				...
				<div class="c_guide_ttl">
					<img src="./img/second_opinion_ttl.png">
				</div>

				<div class="c_second_opinion_step_frame">
					<ul>
						<li>
							<h2>物件所在地の地域情報を簡単に調査する事ができる。</h2>
							<div class="c_second_opinion_step_txt">
								地域調査をするにあたり最も有効な方法は地域に根ざして活動するエージェントに調査依頼するのが最も効果的です。<br>
								購入物件と同一地域にて活動するエージェントは、日頃からその地域で営業活動を行っており地縁のない他府県の業者が持ち合わせていない、目には見えない情報を持ち合わせています。<br>
							</div>
							<div class="c_second_opinion_step_summary">
								<span>
									購入後の入居者募集に関して地域は重要なポイントです。<br>
									購入申し込み前にしっかりと事前調査を複数のエージェントを通じて行いましょう。<br>
								</span>
							</div>
						</li>
						...
						<li>
							<h2>第三者意見として的確な助言</h2>
							<div class="c_second_opinion_step_txt">
								宅地建物取引業では事前告知義務が定められており、物件をご購入して頂くに当たり物件の瑕疵を事前に買主に告知する義務が不動産業者には義務付けられております。しかし、瑕疵物件の定義とは業者またはエージェントごとに異なり曖昧な点が存在します。<br>
								本サービスは物件担当エージェント以外の第三者的意見を購入検討物件と同じ地域で活動するエージェントへ依頼する事が出来ます。<br>
							</div>
							<div class="c_second_opinion_step_summary">
								<span>
									物件担当エージェントの他にも同一エリアで活動するエージェントへ調査依頼を<br>
									行いましょう。<br>
								</span>
							</div>
						</li>
						...
						<li>
							<h2>物件担当エージェントの情報収集</h2>
							<div class="c_second_opinion_step_txt">
								同一地域で活動するエージェントは売主側エージェント、買主側エージェントに別れて同一物件を共同仲介する例は多くあります。すなわち、同一地域のエージェントは面識がある可能性が極めて高いのです。<br>
								本サービスをご利用頂ければ、物件購入前に物件担当エージェントの情報収集が可能になります。<br>
							</div>
							<div class="c_second_opinion_step_summary">
								<span>
									初めて取引をする物件担当エージェントであれば物件調査同様に同一エリアで<br>
									活動するエージェントへ事前に業者調査依頼を行いましょう。<br>
								</span>
							</div>
						</li>
						...
						<li>
							<h2>物件管理業者の情報収集</h2>
							<div class="c_second_opinion_step_txt">
								物件購入をするのがゴールではありません。<br>
								物件購入は収益物件の投資事業においてはスタートであり本事業において重要な要素になってくるのが物件管理業者です。<br>
								購入検討物件を現在、管理している業者のリーシング力はどの位なのか、またはその地域で最もリーシング力のある管理会社を事前調査する事により購入申込書提出前により正確な収益シュミレーションが可能になります。<br>
							</div>
							<div class="c_second_opinion_step_summary">
								<span>
									利回りを向上させるのには地域で最ものリーシング力ある管理会社へ<br>
									管理依頼をする事が有効です。<br>
								</span>
							</div>
						</li>
						...
						<li>
							<h2>リフォーム業者選定に</h2>
							<div class="c_second_opinion_step_txt">
								収益物件をご購入するにあたり室内リフォーム、<br>
								または壁面塗装などが必要になる場合がございます。<br>
								そのような場合においては物件担当エージェントの他に同一地域の<br>
								エージェントを通じて相見積もりをお取りになることを<br>
								お薦め致します。<br>
							</div>
							<div class="c_second_opinion_step_summary">
								<span>
									複数業者へ相見積もりを取ることこそが諸費用を抑えるための有効手段です。
								</span>
							</div>
						</li>
					</ul>
