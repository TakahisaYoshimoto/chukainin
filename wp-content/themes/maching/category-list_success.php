...
<div class="l_main l_sub">
	<div class="p_inner2 p_flex p_jc_between">
		...
		<div class="l_content">
			...
			<div class="c_success_list">
				<ul>

					<li>
						<div class="p_flex">
							<div class="c_success_list_introduction">
								<div class="p_flex p_jc_between p_ai_center">
									<div class="c_success_list_active">
										<ul class="p_flex">
											<li>投資家</li>
											<li>しまぽじ</li>
										</ul>
									</div>
									<div class="c_success_list_regdt">登録日：2017/08/01</div>
								</div>
								<div class="c_success_list_title">
									不安を感じないスムーズな取引でした。
								</div>
								<div class="c_success_list_main p_flex">
									<div class="c_success_list_thumb"><img src="./img/dummy/property.png"></div>
									<div class="c_success_list_main_info">
										<div class="c_success_list_main_other">
								...
								<div class="c_success_list_text_box p_flex p_jc_between">
									<div class="c_success_list_text">
										テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります…
									</div>
									<div class="c_success_list_text_detail">
										<div class="p_bt p_green p_shadow2">
											<a href="./success_detail.html">詳細</a>
										</div>
									</div>
								</div>
							</div>
