   ...
   <div class="wrapper-63">
    ...
    <div class="section_undisclosed_property">
     ...
     <div class="list_1-3 group">
      ...
      <div class="parts109 group">
       ...
       <div class="parts110">
        <p>所在地　：　東京</p>
        <p class="text-126">物件種別：　RC一棟</p>
        <p class="text-216">利回り　：　10％</p>
       </div>
       <img src="http://www.abc-planning.sakura.ne.jp/oc-content/themes/royal/images/top/border_5.png" alt="" width="1" height="72">
       <div class="parts111">
        <p>掲載開始日　　：　2017/7/13</p>
        <p class="text-218">物件公開予定日：　2017/7/20</p>
        <p class="text-219">価格　　　　　：　500万円</p>
       </div>
       <div class="btn-3">
    ...
    <div class="section_agent">
     ...
     <div class="list_1-4 group">
      <div class="ttl-11">
       <div>
        <p>スペックだけでは語り尽くせない魅力を丁寧にお伝えし、「一点ものの住まいとの出会い」…</p>
       </div>
      </div>
      <div class="parts122 group">
       ...
       <div class="parts123">
        <p>活動エリア　：　東京</p>
        <p class="text-216">注力物件　　：　RC一棟, 一棟鉄骨, 一棟木造</p>
        <p class="text-245">昨年取引件数：　51件以上</p>
       </div>
       <div class="btn-7">
        <div class="parts112"></div>
        <div class="parts113">
    ...
    <div>
     ...
     <div class="list_1-5 group">
      ...
      <div class="parts131 group">
       ...
       <div class="parts132">
        <p>投稿者名　　：　しまぽじ</p>
        <p class="text-216">投稿者タイプ ：　投資家</p>
        <p class="text-268">契約完了日 　：　2017/7/20</p>
       </div>
       <img src="http://www.abc-planning.sakura.ne.jp/oc-content/themes/royal/images/top/border_5.png" alt="" width="1" height="72">
       <div class="parts133">
        <p>所在地　：　東京</p>
        <p class="text-216">物件種別：　RC一棟</p>
        <p class="text-268">利回り　：　10％</p>
       </div>
       <div class="btn-11">
        <div class="parts112"></div>
        <div class="parts113">
