...
<?php if(osc_users_enabled()) { ?>
                ...
                <li><a href="<?php echo osc_user_dashboard_url(); ?>"><?php _e("自分のアカウント", 'royal'); ?></a></li>
                ...
                <li><a href="<?php echo osc_register_account_url(); ?>"><?php _e("新規登録", 'royal'); ?></a></li>
                <?php }; ?>
                <?php } ?>
<?php } ?>
<?php if( (osc_users_enabled() && osc_user_is_company() == 1 ) || ( !osc_users_enabled() && !osc_reg_user_post() )) { ?>
