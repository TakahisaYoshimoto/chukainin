<?php
    ...
    define('ROYAL_THEME_VERSION', '1.4.1');
...
if( !function_exists('royal_item_title') ) {
    ...
    if( !function_exists('royal_theme_install') ) {
        function royal_theme_install() {
            ...
            osc_set_preference('version', '1.4.1', 'royal');
...
if( !function_exists('logo_slider') ) {
        function logo_slider() {
             ...
             $html = '<div class="item"><a href="'.osc_get_preference('slider12-link', 'hero').'"><img title="'.osc_get_preference('slider1-us', 'hero').'" alt="'.osc_get_preference('slider1-us', 'hero').'" src="' . osc_current_web_theme_url('images/slider/slider11.jpg') . '" /></a></div>';
...
if( !function_exists('logo_slider_1') ) {
        function logo_slider_1() {
             ...
             $html = '<div class="item"><a href="'.osc_get_preference('slider22-link', 'hero').'"><img title="'.osc_get_preference('slider2-us', 'hero').'" alt="'.osc_get_preference('slider2-us', 'hero').'" src="' . osc_current_web_theme_url('images/slider/slider22.jpg') . '" /></a></div>';
...
if( !function_exists('logo_slider_2') ) {
        function logo_slider_2() {
             ...
             $html = '<div class="item"><a href="'.osc_get_preference('slider32-link', 'hero').'"><img title="'.osc_get_preference('slider3-us', 'hero').'" alt="'.osc_get_preference('slider3-us', 'hero').'" src="' . osc_current_web_theme_url('images/slider/slider33.jpg') . '" /></a></div>';
...
if( !function_exists('logo_slider_3') ) {
        function logo_slider_3() {
             ...
             $html = '<div class="item"><a href="'.osc_get_preference('slider42-link', 'hero').'"><img title="'.osc_get_preference('slider4-us', 'hero').'" alt="'.osc_get_preference('slider4-us', 'hero').'" src="' . osc_current_web_theme_url('images/slider/slider44.jpg') . '" /></a></div>';
...
if( !function_exists('brand_1') ) {
        function brand_1() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/1.jpg') . '" /></div>';
...
if( !function_exists('brand_2') ) {
        function brand_2() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/2.jpg') . '" /></div>';
...
if( !function_exists('brand_3') ) {
        function brand_3() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/3.jpg') . '" /></div>';
...
if( !function_exists('brand_4') ) {
        function brand_4() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/4.jpg') . '" /></div>';
...
if( !function_exists('brand_5') ) {
        function brand_5() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/5.jpg') . '" /></div>';
...
if( !function_exists('brand_6') ) {
        function brand_6() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/6.jpg') . '" /></div>';
...
if( !function_exists('brand_7') ) {
        function brand_7() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/7.jpg') . '" /></div>';
...
if( !function_exists('brand_8') ) {
        function brand_8() {
             ...
             $html = '<div class="item"><img src="' . osc_current_web_theme_url('images/brand/8.jpg') . '" /></div>';
...
if( !function_exists('osc_search_number') ) {
 ...
 function chosen_select_standard() {
        ...
        if( osc_count_categories() > 0 ) {
            echo '<select name="sCategory" class="anita" data-placeholder="' . __('Select a category', 'royal') . '" class="ima">' ;
            echo '<option value="">' . __('Select a category', 'royal') . '</option>' ;
            while( osc_has_categories() ) {
                echo '<option class="opt1" value="' . osc_category_id() . '">' . osc_category_name() . '</option>' ;
                if( osc_count_subcategories() > 0 ) {
                    while( osc_has_subcategories() ) {
                        echo '<option class="level-1" value="' . osc_category_id() . '">&nbsp;&nbsp;&nbsp;' . osc_category_name() . '</option>' ;
                    }
                }
            }
            echo '</select>' ;
    ...
    function chosen_select_optgroup() {
        ...
        if( osc_count_categories() > 0 ) {
            echo '<select name="sCategory" id="royal_sCategory_chosen" data-placeholder="' . __('Select a category', 'royal') . '" class="ima">' ;
